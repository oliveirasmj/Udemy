...
public class DepartmentListController implements Initializable, DataChangeListener{
	...
	@FXML
	public void onBtNewAction(ActionEvent event) { //recebe um argumento para ter um controlo de quem é o pai e o filho ao abrir nova janela
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) { //Criar janela para registar Department ou Editar
		//recebendo como 3o argumento uma referencia para o stage que criou a janela de dialogo
		//recebendo como 1o elemento o Deparment - caso se clique em editar - se clicar em New passa vazio
		try {
			...
			DepartmentFormController controller = loader.getController(); //pegar o controlador do form para poder alterar os seus valores
