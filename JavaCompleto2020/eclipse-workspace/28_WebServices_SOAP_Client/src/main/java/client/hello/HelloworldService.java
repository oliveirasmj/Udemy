 ...
 * 
 */
@WebServiceClient(name = "HelloworldService", targetNamespace = "http://world.hello/", wsdlLocation = "http://127.0.0.1:9999/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://world.hello/", "HelloworldService");
    ...
    public Helloworld getHelloworldPort() {
        return super.getPort(new QName("http://world.hello/", "HelloworldPort"), Helloworld.class);
    }
    ...
    public Helloworld getHelloworldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://world.hello/", "HelloworldPort"), Helloworld.class, features);
    }
