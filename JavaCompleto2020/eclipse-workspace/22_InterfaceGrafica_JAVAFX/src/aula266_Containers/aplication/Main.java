package aula266_Containers.aplication;
...
//	}
	...
	public void start(Stage stage) {
		try {
			Parent parent = FXMLLoader.load(getClass().getResource("/aula266_Containers/gui/View.fxml")); //carregar a tela(chamando o ficheiro View.xml), num objeto tipo Parent 
