package aula262_Alert.aplication;
...
//	}
	...
	public void start(Stage stage) {
		try {
			Parent parent = FXMLLoader.load(getClass().getResource("/aula262_Alert/gui/View.fxml")); //carregar a tela(chamando o ficheiro View.xml), num objeto tipo Parent 
