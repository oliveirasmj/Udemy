package aula265_ComboBox.aplication;
...
//	}
	...
	public void start(Stage stage) {
		try {
			Parent parent = FXMLLoader.load(getClass().getResource("/aula265_ComboBox/gui/View.fxml")); //carregar a tela(chamando o ficheiro View.xml), num objeto tipo Parent 
