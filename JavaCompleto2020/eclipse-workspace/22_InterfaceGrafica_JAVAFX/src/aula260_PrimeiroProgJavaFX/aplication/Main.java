package aula260_PrimeiroProgJavaFX.aplication;
...
//	}
	...
	public void start(Stage stage) {
		try {
			Parent parent = FXMLLoader.load(getClass().getResource("/aula260_PrimeiroProgJavaFX/gui/View.fxml")); //carregar a tela(chamando o ficheiro View.xml), num objeto tipo Parent 
