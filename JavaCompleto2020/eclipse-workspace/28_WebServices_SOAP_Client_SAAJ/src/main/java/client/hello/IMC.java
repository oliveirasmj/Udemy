...
public class IMC {
	...
	public static void main(String[] args) throws SOAPException, MalformedURLException {
		...
		QName bodyName = new QName("http://world.hello/", "indice", "m");// m é o que envia do genero <m></m>
		...
		QName name = new QName("peso"); // nome da variavel para o exterior no Server
		QName name2 = new QName("altura"); // nome da variavel para o exterior no Server
		...
		arg0.addTextNode("67");
		arg1.addTextNode("1.74");
		// Identificação do Endpoint
		URL ep = new URL(String.format("http://localhost:9999/imc"));
		...
		// Realiza a invocação do serviço enviado a mensagem SOAP (sm) para o endpoint (
		// ep )
